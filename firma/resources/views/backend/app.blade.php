                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a> Blog <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="/admin/blog/blog_ekle">Blog Ekle</a></li>
                                    <li><a href="/admin/blog/kategoriler">Kategoriler</a></li>
                                    <li><a href="/admin/blog/kategori_ekle">Kategori Ekle</a></li>
                                </ul>
                            </li>
                            <li><a href="/admin/hakkimizda"><i class="fa fa-cog"></i> Hakkimizda </a></li>
