...
Route::group(['prefix'=>'admin', 'middleware'=>'Admin'],function (){
	...
	Route::group(['prefix'=>'blog'],function (){
	    ...
	    Route::get('/blog_ekle', "AdminGetController@get_blog_ekle");
	    Route::post('/blog_ekle', "AdminPostController@post_blog_ekle");
	    Route::get('/blog_duzenle/{slug}', "AdminGetController@get_blog_duzenle");
	    Route::post('/blog_duzenle/{slug}', "AdminPostController@post_blog_duzenle");
	    Route::get('/kategori_ekle', "AdminGetController@get_kategori_ekle");
	    Route::post('/kategori_ekle', "AdminPostController@post_kategori_ekle");
